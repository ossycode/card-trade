      ...
      <AppScreen.Body>
        <div className="p-4">
          <div className="flex gap-2">
            <div className="text-xs/6 text-gray-900">Card Marketplace</div>
          ...
          <div className="mt-3 border-t border-gray-200 pt-5">
              ...
              {percentageChange && (
                <div
                  className={clsx(
                    ...
                    percentageChange >= 0 ? 'text-cyan-500' : 'text-red-500',
                  )}
                >
            ...
            <div className="mt-3 divide-y divide-gray-100 text-sm">
              <div className="flex justify-between py-1">
                <div className="text-gray-500">Recent Sale</div>
                <div className="font-medium text-gray-900">$68.00</div>
              </div>
              <div className="flex justify-between py-1">
                <div className="text-gray-500">Highest Sale</div>
                <div className="font-medium text-gray-900">$102.50</div>
              </div>
              <div className="flex justify-between py-1">
                <div className="text-gray-500">Lowest Sale</div>
                <div className="font-medium text-gray-900">$42.00</div>
              </div>
            </div>
          </div>
        </div>
